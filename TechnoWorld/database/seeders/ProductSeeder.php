    ...
    public function run(): void
    {
        ...
        $products = [
            ...
            [
                ...
                'description' => 'The De\'Longhi Magnifica S is the perfect gateway into super-automatic espresso for households that want café-quality drinks without the complexity of manual machines. Its patented Direct-to-Brew system grinds fresh beans and brews coffee in a single integrated process.',
                'price' => 749.99,
                'stock_quantity' => 5,
            ],
            [
            ...
            [
                ...
                'description' => 'The Samsung MS23K3513 is a straightforward yet cleverly designed solo microwave that brings durability and easy cleaning together in a compact 23-litre package. Its ceramic enamel interior is scratch-resistant, anti-bacterial, and far easier to wipe clean than conventional painted surfaces.',
                'price' => 179.99,
                'stock_quantity' => 6,
            ],
            [
            ...
            [
                ...
                'description' => 'The Samsung Galaxy A55 5G brings flagship-inspired features to the mid-range tier, starting with a large 6.6-inch Super AMOLED display running at a smooth 120Hz refresh rate. The 50 MP main camera with Optical Image Stabilisation takes clear, detailed photos in low light.',
                'price' => 369.99,
                'stock_quantity' => 9,
            ],
            [
                ...
                'description' => 'The Xiaomi 14 is a compact flagship that refuses to compromise, packing the most powerful mobile chipset available - the Snapdragon 8 Gen 3 - into a pocket-friendly 6.36-inch form factor. The Leica-tuned triple camera system is the star of the show.',
                'price' => 849.99,
                'stock_quantity' => 4,
            ],
            [
                ...
                'description' => 'The Google Pixel 8a delivers the most desirable Pixel features at a mid-range price: the Tensor G3 chip powers industry-leading computational photography and on-device AI tools. Magic Eraser removes unwanted people and objects from shots.',
                'price' => 539.99,
                'stock_quantity' => 11,
            ],
            [
                ...
                'description' => 'The Anker PowerCore 26800 is the travel power bank for adventurers and frequent flyers who cannot afford to run out of charge. Its colossal 26800 mAh capacity translates to roughly six full smartphone charges or one to two full laptop charges.',
                'price' => 64.99,
                'stock_quantity' => 7,
            ],
            [
                ...
                'description' => 'The Bosch KGN36VWEQ is a free-standing fridge-freezer that brings intelligent freshness management and frost-free convenience to a sleek, modern kitchen. Its NoFrost system circulates cold air evenly through both compartments, eliminating the build-up of ice crystals entirely.',
                'price' => 649.99,
                'stock_quantity' => 3,
            ],
            [
                ...
                'description' => 'The Dyson V11 is the cordless vacuum that redefined what is possible without a power cord. Its High Torque XL cleaner head contains sensors that detect floor type and automatically increase or reduce suction motor speed to clean carpets and hard floors optimally.',
                'price' => 549.99,
                'stock_quantity' => 6,
            ],
            [
                ...
                'description' => 'The Rowenta X-Force 9.60 is a cordless vacuum built around flexibility and ease of use. Its patented X-Force Flex motor technology combines a high-efficiency brushless motor with an articulating neck that bends to reach under low furniture without kneeling.',
                'price' => 329.99,
                'stock_quantity' => 8,
            ],
            [
                ...
                'description' => 'The Samsung Galaxy Watch 6 is one of the most health-focused smartwatches on the market, built around its upgraded BioActive Sensor that tracks body composition, heart rate, blood oxygen, and ECG from a single optical array on the underside of the watch.',
                'price' => 329.99,
                'stock_quantity' => 8,
            ],
            [
                ...
                'name' => 'Vertuo Next Coffee Machine',
                'short_description' => 'Versatile capsule coffee machine with Centrifusion technology, 5 cup sizes from espresso to alto, and built-in Wi-Fi for app control.',
                'description' => 'The Nespresso Vertuo Next uses Centrifusion technology to brew a perfectly extracted cup with a generous crema every time. Simply insert a capsule, close the lever, and your coffee is ready in under 30 seconds.',
                'price' => 149.99,
                'stock_quantity' => 13,
            ],
        ];
