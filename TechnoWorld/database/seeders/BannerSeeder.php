    ...
    public function run(): void
    {
        $banners = [
            ...
            [
                ...
                'product_name' => 'Royal Professional Coffee Maker',
                'carousel' => 'featured',
                'tag' => 'This Week Only',
                'title' => "Royal Professional Coffee Maker\nFlash Price",
                'description' => 'Bring cafe-level espresso home with this premium automatic coffee maker',
                'cta_text' => 'Grab Coffee S Deal',
                'image_path' => 'coffee-maker/saeco-royal-professional/image.png',
                'image_alt' => 'Royal Professional Coffee Maker',
                'slide_class' => 'carousel-slide-1',
            ...
            [
                ...
                'product_name' => 'Complete C3 Vacuum',
                'carousel' => 'featured',
                'tag' => 'Just Landed',
                'title' => "Complete C3 Vacuum\nNow in Store",
